...
class TestGeometrySerde(TestBase):
    @pytest.mark.parametrize(
        ...
        [
            GeometryCollection(
                [
                    Point([10.0, 20.0]),
                    Polygon([(10.0, 10.0), (20.0, 20.0), (20.0, 10.0)]),
                ]
            ),
            ...
            MultiPolygon(
                [
                    ...
                    Polygon(
                        [(-10.0, -10.0), (-20.0, -20.0), (-20.0, -10.0), (-10.0, -10.0)]
                    ),
                ]
            ),
            MultiPolygon(
    ...
    def test_spark_serde_compatibility_with_scala(self, wkt):
        ...
        returned_wkt = (
            TestGeometrySerde.spark.createDataFrame([(geom,)], schema)
        ...
        returned_geom = (
            TestGeometrySerde.spark.createDataFrame([(wkt,)], schema)
