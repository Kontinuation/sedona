...
class SedonaMetrics extends Source {
  ...
  val jobsCompleteMetric: Counter =
    createCounterMetric("jobsCompleted", "Number of Sedona jobs completed")
  val stagesCompleteMetric: Counter =
    createCounterMetric("stagesCompleted", "Number of Sedona stages completed")
  val tasksCompleteMetric: Counter =
    createCounterMetric("tasksCompleted", "Number of Sedona tasks completed")
  val executorRuntimeMetric: Counter =
    createCounterMetric("executorRuntime", "Total executor runtime in milliseconds")
  val recordsReadMetric: Counter = createCounterMetric("recordsRead", "Total records read")
  val recordsWrittenMetric: Counter =
    createCounterMetric("recordsWritten", "Total records written")
  ...
  val jobExecutiontimeMetric: Timer =
    createTimerMetric("jobExecutionTime", "Total job execution time in nanoseconds")
  val jobFailedMetric: Counter = createCounterMetric("jobFailed", "Number of failed Sedona jobs")
  val jobSuccessMetric: Counter =
    createCounterMetric("jobSuccess", "Number of successful Sedona jobs")
  ...
  private def getFunctionNames(): mutable.HashSet[String] = {
    ...
    Catalog.aggregateExpressions.foreach(f =>
      functionNameSetBuilder += f.getClass.getSimpleName.toLowerCase)
  ...
  private def createCounterMetricMap(): mutable.HashMap[String, Counter] = {
    ...
    functionNames.foreach(f =>
      counterMap.put(f, createCounterMetric(f, "Number of " + f + " function calls")))
    counterMap
  }
}
