...
object PythonEvalType {
  ...
  val SQL_SCALAR_SEDONA_ARROW_BATCH_UDF = 6202
  ...
  def toString(pythonEvalType: Int): String = pythonEvalType match {
    ...
    case SQL_SCALAR_SEDONA_DB_SPEEDUP_UDF => "SQL_SCALAR_SEDONA_DB_SPEEDUP_UDF"
    case SQL_SCALAR_SEDONA_ARROW_BATCH_UDF => "SQL_SCALAR_SEDONA_ARROW_BATCH_UDF"
  }
