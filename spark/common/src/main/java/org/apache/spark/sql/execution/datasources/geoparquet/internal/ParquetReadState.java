...
public final class ParquetReadState {
  ...
  public int valuesToReadInPage;

  /** The remaining number of rows to read in the current batch */
  public int rowsToReadInBatch;
   ...
   * current batch.
   */
  public boolean lastListCompleted;

  /** When processing repeated types, the number of accumulated definition levels to process */
  int numBatchedDefLevels;

  /**
   * When processing repeated types, whether we should skip the current batch of definition levels.
   */
  boolean shouldSkip;

  public ParquetReadState(
  ...
  public void resetForNewBatch(int batchSize) {
    this.valueOffset = 0;
    this.levelOffset = 0;
  ...
  public void resetForNewPage(int totalValuesInPage, long pageFirstRowIndex) {
