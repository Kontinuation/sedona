...
public class ParquetVectorUpdaterFactory {
  ...
  public ParquetVectorUpdaterFactory(
  ...
  public boolean isTimestampTypeMatched(LogicalTypeAnnotation.TimeUnit unit) {
  ...
  public boolean isUnsignedIntTypeMatched(int bitWidth) {
