...
public class RasterOverlayOperator {
     ...
     */
    public RasterOverlayOperator(
            JavaPairRDD<Integer, ImageSerializableWrapper> distributedBackRasterImage) {
    ...
    public boolean JoinImage(JavaPairRDD<Integer, ImageSerializableWrapper> distributedFontImage)
        ...
        this.distributedBackRasterImage =
                this.distributedBackRasterImage
                        .cogroup(distributedFontImage)
                        .mapToPair(
                                new PairFunction<
                                        Tuple2<
                                                Integer,
                                    ...
                                    public Tuple2<Integer, ImageSerializableWrapper> call(
                                        ...
                                        Iterator<ImageSerializableWrapper> backImageIterator =
                                        ...
                                        if (backImage.getWidth() != frontImage.getWidth()
                                                || backImage.getHeight()
                                        ...
                                        return new Tuple2<Integer, ImageSerializableWrapper>(
                                                imagePartitionId,
    ...
    public boolean JoinImage(BufferedImage frontRasterImage) throws Exception {
        ...
        if (backRasterImage.getWidth() != frontRasterImage.getWidth()
                || backRasterImage.getHeight() != frontRasterImage.getHeight()) {
            throw new Exception(
                    "[OverlayOperator][JoinImage] The two given image don't have the same width or"
                            + " the same height.");
        }
