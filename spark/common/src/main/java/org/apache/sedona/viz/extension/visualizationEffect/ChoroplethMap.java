    ...
    */
    ...
    protected Color EncodeToColor(int normailizedCount) throws Exception {
        if (controlColorChannel.equals(Color.RED)) {
            ...
            throw new Exception(
                    "[VisualizationOperator][GenerateColor] Unsupported changing color color type."
                            + " It should be in R,G,B");
        }
    ...
    public boolean Visualize(
            JavaSparkContext sparkContext, JavaPairRDD<Polygon, Long> spatialPairRDD)
            throws Exception {
