                ...
                new FlatMapFunction<Geometry, Point>() {
                    ...
                    public Iterator<Point> call(Geometry spatialObject) throws Exception {
                        ...
                        if (spatialObject instanceof MultiPoint) {
                            ...
                            throw new Exception(
                                    "[ShapefileRDD][getPointRDD] the object type is not Point or"
                                            + " MultiPoint type. It is "
                ...
                new FlatMapFunction<Geometry, Polygon>() {
                    ...
                    public Iterator<Polygon> call(Geometry spatialObject) throws Exception {
                        ...
                        if (spatialObject instanceof MultiPolygon) {
                            ...
                            throw new Exception(
                                    "[ShapefileRDD][getPolygonRDD] the object type is not Polygon"
                                            + " or MultiPolygon type. It is "
                                            + spatialObject.getGeometryType());
                        }
                        return result.iterator();
                    }
                ...
                new FlatMapFunction<Geometry, LineString>() {
                    ...
                    public Iterator<LineString> call(Geometry spatialObject) throws Exception {
                        ...
                        if (spatialObject instanceof MultiLineString) {
                            ...
                            throw new Exception(
                                    "[ShapefileRDD][getLineStringRDD] the object type is not"
                                            + " LineString or MultiLineString type. It is "
                                            + spatialObject.getGeometryType());
                        }
                        return result.iterator();
                    }
