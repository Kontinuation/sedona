...
/**
 * Implementation of IntervalTree using a linear list of Envelopes. This implementation does not use
...
public class IntervalTree extends PartitioningUtils implements Serializable {
  ...
  public void build(int neighborSampleNumber, double samplingProbability) {
    this.ranges =
        this.zOrderPartitioning.createZOrderRanges(
            samples, neighborSampleNumber, samplingProbability);
