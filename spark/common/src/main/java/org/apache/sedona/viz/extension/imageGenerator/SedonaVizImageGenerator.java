...
public class SedonaVizImageGenerator extends ImageGenerator {
    ...
    //     */
    //    public boolean SaveRasterImageAsLocalFile(JavaPairRDD<Integer, ImageSerializableWrapper>
    // distributedImage, final String outputPath, final ImageType imageType, final int zoomLevel,
    // final int partitionOnX, final int partitionOnY)
    //            throws Exception
    //    {
    //        logger.info("[Sedona-VizViz][SaveRasterImageAsLocalFile][Start]");
    //        for (int i = 0; i < partitionOnX * partitionOnY; i++) {
    //            deleteLocalFile(outputPath + "-" + RasterizationUtils.getImageTileName(zoomLevel,
    // partitionOnX, partitionOnY, i), imageType);
    //        }
    //        distributedImage.foreach(new VoidFunction<Tuple2<Integer, ImageSerializableWrapper>>()
    //        {
    //            @Override
    //            public void call(Tuple2<Integer, ImageSerializableWrapper>
    // integerImageSerializableWrapperTuple2)
    //                    throws Exception
    //            {
    //
    // SaveRasterImageAsLocalFile(integerImageSerializableWrapperTuple2._2.getImage(), outputPath +
    // "-" + RasterizationUtils.getImageTileName(zoomLevel, partitionOnX, partitionOnY,
    // integerImageSerializableWrapperTuple2._1), imageType);
    //            }
    //        });
    ...
    //     * @throws Exception the exception
    //     */
    //    public boolean SaveRasterImageAsHadoopFile(JavaPairRDD<Integer, ImageSerializableWrapper>
    // distributedImage, final String outputPath, final ImageType imageType, final int zoomLevel,
    // final int partitionOnX, final int partitionOnY)
    //            throws Exception
    //    {
    ...
    //        for (int i = 0; i < partitionOnX * partitionOnY; i++) {
    //            deleteHadoopFile(outputPath + "-" + RasterizationUtils.getImageTileName(zoomLevel,
    // partitionOnX, partitionOnY, i) + ".", imageType);
    //        }
    //        distributedImage.foreach(new VoidFunction<Tuple2<Integer, ImageSerializableWrapper>>()
    //        {
    ...
    //            {
    //
    // SaveRasterImageAsHadoopFile(integerImageSerializableWrapperTuple2._2.getImage(), outputPath +
    // "-" + RasterizationUtils.getImageTileName(zoomLevel, partitionOnX, partitionOnY,
    // integerImageSerializableWrapperTuple2._1), imageType);
    //            }
    //        });
    ...
    //     * @return true, if successful
    //     */
    //    public boolean SaveRasterImageAsS3File(JavaPairRDD<Integer, ImageSerializableWrapper>
    // distributedImage,
    //            final String regionName, final String accessKey, final String secretKey,
    //            final String bucketName, final String path, final ImageType imageType, final int
    // zoomLevel, final int partitionOnX, final int partitionOnY)
    //    {
    ...
    //        for (int i = 0; i < partitionOnX * partitionOnY; i++) {
    //            s3Operator.deleteImage(bucketName, path + "-" +
    ...
    //                    throws Exception
    //            {
    //                SaveRasterImageAsS3File(integerImageSerializableWrapperTuple2._2.getImage(),
    // regionName, accessKey, secretKey, bucketName, path + "-" +
    // RasterizationUtils.getImageTileName(zoomLevel, partitionOnX, partitionOnY,
    // integerImageSerializableWrapperTuple2._1), imageType);
    //            }
    //        });
    ...
    //     * @throws Exception the exception
    //     */
    //    public boolean SaveRasterImageAsLocalFile(BufferedImage rasterImage, String outputPath,
    // ImageType imageType)
    //            throws Exception
    //    {
    //        logger.info("[Sedona-VizViz][SaveRasterImageAsLocalFile][Start]");
    ...
    //     * @throws Exception the exception
    //     */
    //    public boolean SaveRasterImageAsHadoopFile(BufferedImage rasterImage, String
    // originalOutputPath, ImageType imageType)
    //            throws Exception
    //    {
    //        logger.info("[Sedona-VizViz][SaveRasterImageAsHadoopFile][Start]");
    //        // Locate HDFS path
    ...
    //        logger.info("[Sedona-VizViz][SaveRasterImageAsSparkFile] HDFS URI BASE: " + hostName +
    // ":" + port);
    //        FileSystem hdfs = FileSystem.get(new URI(hostName + ":" + port), hadoopConf);
    //        logger.info("[Sedona-VizViz][SaveRasterImageAsSparkFile] Check the existence of path:
    // " + localPath);
    //        if (hdfs.exists(new org.apache.hadoop.fs.Path(localPath))) {
    //            logger.info("[Sedona-VizViz][SaveRasterImageAsSparkFile] Deleting path: " +
    // localPath);
    //            hdfs.delete(new org.apache.hadoop.fs.Path(localPath), true);
    //            logger.info("[Sedona-VizViz][SaveRasterImageAsSparkFile] Deleted path: " +
    // localPath);
    //        }
    ...
    //     */
    //    public boolean SaveRasterImageAsS3File(BufferedImage rasterImage, String regionName,
    // String accessKey, String secretKey, String bucketName, String path, ImageType imageType)
    //            throws IOException
    //    {
    //        logger.info("[Sedona-VizViz][SaveRasterImageAsS3File][Start]");
    //        S3Operator s3Operator = new S3Operator(regionName, accessKey, secretKey);
    ...
    //     * @throws Exception the exception
    //     */
    //    public boolean SaveVectorImageAsLocalFile(JavaPairRDD<Integer, String> distributedImage,
    ...
    //     * @throws Exception the exception
    //     */
    //    public boolean SaveVectorImageAsLocalFile(List<String> vectorImage, String outputPath,
    // ImageType imageType)
    //            throws Exception
    //    {
    ...
    //     */
    //    public boolean SaveRasterImageAsLocalFile(JavaPairRDD<Integer, ImageSerializableWrapper>
    // distributedImage, String outputPath, ImageType imageType)
    //            throws Exception
    //    {
    ...
    //            SaveRasterImageAsLocalFile(imagePartition._2.getImage(), outputPath + "-" +
    // imagePartition._1, imageType);
    //        }
    //        return true;
    //    }
}
