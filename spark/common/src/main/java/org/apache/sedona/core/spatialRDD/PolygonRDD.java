                ...
                this.rawSpatialRDD.reduce(
                        new Function2<Polygon, Polygon, Polygon>() {
                            public Polygon call(Polygon v1, Polygon v2) {
                                ...
                                GeometryPrecisionReducer pReducer =
                                        new GeometryPrecisionReducer(pModel);
