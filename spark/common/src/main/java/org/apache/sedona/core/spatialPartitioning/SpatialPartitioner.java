...
public abstract class SpatialPartitioner extends Partitioner implements Serializable {
     ...
     *
     * <p>For points, returns exactly one partition as long as grid type is non-overlapping. For
     * other geometry types or for overlapping grid types, may return multiple partitions.
     */
