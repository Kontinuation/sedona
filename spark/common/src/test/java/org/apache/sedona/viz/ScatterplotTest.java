...
public class ScatterplotTest extends VizTestBase {
    /**
    ...
    public void testEncodeDecodeId() throws Exception {
        ...
        Tuple2<Integer, Integer> pixelCoordinate =
                RasterizationUtils.Decode1DTo2DId(resolutionX, resolutionY, serialId);
    ...
    public void testPointRDDVisualization() throws Exception {
        ...
        imageGenerator.SaveRasterImageAsLocalFile(
                visualizationOperator.rasterImage, "./target/scatterplot/PointRDD", ImageType.PNG);
    ...
    public void testPointRDDVisualizationWithParallelRendering() throws Exception {
        ...
        imageGenerator.SaveRasterImageAsLocalFile(
                ...
                "./target/heatmap/PointRDD-parallelrender",
                ImageType.PNG,
                0,
                4,
                4);
        ImageStitcher.stitchImagePartitionsFromLocalFile(
                "./target/scatterplot/PointRDD-parallelrender", 1000, 600, 0, 4, 4);
    }
    ...
    public void testSaveAsDistributedFile() throws Exception {
        PointRDD spatialRDD =
                new PointRDD(
                        ...
                        PointNumPartitions);
        ScatterPlot visualizationOperator =
                new ScatterPlot(1000, 600, USMainLandBoundary, false, 2, 2, true, false);
        visualizationOperator.CustomizeColor(255, 255, 255, 255, Color.GREEN, true);
        visualizationOperator.Visualize(sparkContext, spatialRDD);
        ImageGenerator imageGenerator = new ImageGenerator();
        ...
        imageGenerator.SaveRasterImageAsLocalFile(
                visualizationOperator.distributedRasterImage,
                scatterPlotOutputPath + "PointRDD-parallel-raster",
                ImageType.PNG);
    ...
    public void testRectangleRDDVisualization() throws Exception {
        ...
        ImageGenerator imageGenerator = new ImageGenerator();
        imageGenerator.SaveRasterImageAsLocalFile(
                visualizationOperator.rasterImage,
                "./target/scatterplot/RectangleRDD",
                ImageType.GIF);
    ...
    public void testLineStringRDDVisualization() throws Exception {
        ...
        ScatterPlot visualizationOperator =
                new ScatterPlot(resolutionX, resolutionY, USMainLandBoundary, false);
        visualizationOperator.CustomizeColor(255, 255, 255, 255, Color.GREEN, true);
        visualizationOperator.Visualize(sparkContext, spatialRDD);
        ImageGenerator imageGenerator = new ImageGenerator();
        imageGenerator.SaveRasterImageAsLocalFile(
                visualizationOperator.rasterImage,
                "./target/scatterplot/LineStringRDD",
                ImageType.GIF);
