...
export WHEROBOTS_AWS_S3BUCKET="test-wherobots-user-logs/s3-log-tester"
export WHEROBOTS_PRODUCT="sedona-enterprise"
...
echo "WHEROBOTS_PRODUCT is set to: $WHEROBOTS_PRODUCT"