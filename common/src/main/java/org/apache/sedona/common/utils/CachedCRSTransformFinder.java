...
public class CachedCRSTransformFinder {
    ...
    private static class CRSPair {
        ...
        public boolean equals(Object obj) {
            ...
            // Here we use == instead of equals deliberately because CRS objects will be heavily
            // reused
            // throughout the system. Different rasters with same CRS definition will have a high
            // probability
            // of using the same CRS object.
            //
            // There are cases where two CRS objects are equal but not the same object. In this
            // case, the
            // CRS.findTransform method will look up its internal cache using the equals() method,
            // which is pretty
            // slow. This CachedCRSTransformFinder will accelerate the cases where there are
            // multiple (but not too many)
            // equivalent CRS objects. Typically, there could be 2 equivalent CRS objects: one
            // created from looking up
