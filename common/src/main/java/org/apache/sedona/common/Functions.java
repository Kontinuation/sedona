...
public class Functions {
  ...
  public static Geometry[] extentBasedSubDivide(
      Geometry geometry, double maxWidth, double maxHeight) {
    return extentBasedSubDivide(geometry, maxWidth, maxHeight, "//");
  }

  public static Geometry[] extentBasedSubDivide(
      Geometry geometry, double maxWidth, double maxHeight, String algorithms) {
  ...
  public static Geometry[] extentBasedSubDivide(
    ...
    if (algorithmsArray.length != 3) {
      throw new IllegalArgumentException(
          "algorithms is not in the correct format (should be <algMultiPoint>/<algLineString>/<algPolygon>)");
    }
    ...
    if (algorithmsArray[0].isEmpty()) {
      ...
      algMultiPoint =
          SubdivideOptions.MultiPointSubDivider.valueOf(
              algorithmsArray[0].toUpperCase(Locale.ROOT));
    }
    ...
    if (algorithmsArray[1].isEmpty()) {
      ...
      algLineString =
          SubdivideOptions.LineStringSubDivider.valueOf(
              algorithmsArray[1].toUpperCase(Locale.ROOT));
    }
    ...
    if (algorithmsArray[2].isEmpty()) {
      ...
      algPolygon =
          SubdivideOptions.PolygonSubDivider.valueOf(algorithmsArray[2].toUpperCase(Locale.ROOT));
    }
    SubdivideOptions options =
        new SubdivideOptions(
            maxCoordinates,
            maxWidth,
            maxHeight,
            maxDepth,
