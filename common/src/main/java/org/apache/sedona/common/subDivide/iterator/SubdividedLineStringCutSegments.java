...
/**
 * Subdivide a line string into segments. The segments are cut at the points where the length of the segment exceeds
 * the maximum length. Cutting segments may introduce some numerical errors, but it should be negligible for most
 * applications. If you really need to avoid numerical errors at all, you can try
 * {@link SubdividedLineStringPreserveSegments}.
 */
