...
/**
 * Subdivide a line string into smaller line strings of a given maximum length. We don't cut in the
 * middle of segments of the line string, but only split the line string at the vertices. The
 * subdivided line strings could be slightly larger than the maximum length.
 */
