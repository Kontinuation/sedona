 ...
 * final.
 * <p>
 * The implementation of this class is inspired by and simplified from the
...
public class BufferedRandomAccessFile implements AutoCloseable {
    ...
    /**
     * The offset in bytes from the raf start, of the next read or write
     * operation.
     */
     ...
     * of the raf. This can be calculated from
     ...
     *
     * @param pos
     *            the offset (in bytes) from the start of the raf.
     */
     ...
     * offset <code>off</code> to this raf.
     *
     * @param b
     *            the data.
     * @param off
