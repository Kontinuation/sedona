...
public final class GeometrySplitter {
   ...
   * LineString, MultiLineString, or a homogeneous collection of lines in a GeometryCollection. The
   * blade geometry can be any individual puntal, lineal, or polygonal geometry or homogeneous
  ...
  /**
   * Split polygonal input geometry by the blade geometry. Input geometry is assumed to be either a
   * Polygon, MultiPolygon, or a GeometryCollection of only polygons. The blade geometry can be any
   * individual lineal or polygonal geometry or homogeneous collection of those geometries. Blades
   * that are polygonal will use their boundary for the split. Will always return a MultiPolygon.
   *
  ...
  private void applyCoordsToLineSegment(
      LinearGeometryBuilder lineBuilder, Iterator<Coordinate> coordIterator, Coordinate endCoord) {
