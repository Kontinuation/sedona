...
public class RasterAIFunctions {
    ...
    public static List<ExtractedRegionInfo> segmentToGeoms(
        ...
        MathTransform transform = CRS.findMathTransform(
                ref.getCoordinateReferenceSystem(), DefaultGeographicCRS.WGS84, true);
        ...
        List<RasterPolygonizer.PolygonWithValue> polygonsWithValues = RasterPolygonizer.polygonize(grid, width, 4, affine);
        ...
        for (int labelIndex = 0; labelIndex < numClasses; labelIndex++) {
            ...
            results.add(new ExtractedRegionInfo(transformed, averageScores[labelIndex], labelArray[labelIndex]));
        }
