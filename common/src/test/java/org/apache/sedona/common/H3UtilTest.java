...
public class H3UtilTest {
                        ...
                        shellHoles -> {
                            ...
                            if (rings.isEmpty()) {
                                ...
                                return GEOMETRY_FACTORY.createPolygon(
                                        shell, rings.toArray(new LinearRing[0]));
                            }
                        })
                .toArray(Polygon[]::new);
    }
    ...
    public void polygonToCells() throws ParseException {
        Polygon target =
                (Polygon)
                        new WKTReader()
                                .read(
                                        "POLYGON((-122.5062527079981"
                                                + " 37.77488349032218,-122.5007595439356"
                                                + " 37.732537587382446,-122.48839992479498"
                                                + " 37.67223433509411,-122.3963894267481"
                                                + " 37.69505755123785,-122.39501613573248"
                                                + " 37.788450765773675,-122.46505397752935"
                                                + " 37.79984535251623,-122.5062527079981"
                                                + " 37.77488349032218))");
        ...
        // generate the reversed polygons from cells, the h3 generate 1 compacted polygon for
        // conjective cells
        Polygon cellPolygon = cellsToJTSPolygons(cells)[0];
        // the reversed polygons from cells must all intersect with the polygon, this means the
        // indexing geographically make sense
    ...
    public void polygonToCellsNoMatch() throws ParseException {
        Polygon target =
                (Polygon)
                        new WKTReader()
                                .read(
                                        "POLYGON ((-122.3852447 47.5606571, -122.385248"
                                            + " 47.5605286, -122.385326 47.5605296, -122.3853281"
                                            + " 47.5604473, -122.3852624 47.5604465, -122.3852646"
                                            + " 47.5603628, -122.3853411 47.5603637, -122.3853543"
                                            + " 47.5598464, -122.3846514 47.5598382, -122.3846307"
                                            + " 47.5606499, -122.3852447 47.5606571))");
    ...
    public void polygonOnPentagonToCells() throws ParseException {
        Polygon target =
                (Polygon)
                        new WKTReader()
                                .read(
                                        "POLYGON((10.47311531687734"
                                                + " 64.74411329535432,10.427796713361715"
                                                + " 64.67488499523719,10.543153158674215"
                                                + " 64.64902571378299,10.674989096174215"
                                                + " 64.68017135781035,10.595338217267965"
                                                + " 64.76636949080041,10.47311531687734"
                                                + " 64.74411329535432))");
    ...
    public void polygonWithHolesToCells() throws ParseException {
        Polygon target =
                (Polygon)
                        new WKTReader()
                                .read(
                                        "POLYGON((-122.49150256862254"
                                                + " 37.76006117790207,-122.46506671657176"
                                                + " 37.78394270449753,-122.41906146754832"
                                                + " 37.77715896429647,-122.3905656789741"
                                                + " 37.74187348046013,-122.42524127711863"
                                                + " 37.71254658823643,-122.47811298122019"
                                                + " 37.72666839340869,-122.49150256862254"
                                                + " 37.76006117790207), (-122.44927386989207"
                                                + " 37.73752948850401,-122.42798785914988"
                                                + " 37.74920338883217,-122.42730121364207"
                                                + " 37.76196112716144,-122.46335010280222"
                                                + " 37.76250396084337,-122.44927386989207"
                                                + " 37.73752948850401)))");
                ...
                assertThrows(
                        ...
                        () -> {
                            H3Utils.polygonToCells(
                                    (Polygon)
                                            new WKTReader().read("POLYGON ((75 29, 77 29, 75 29))"),
                                    7,
                                    true);
                        });
    ...
    public void approxPathCells() {
        ...
        List<Long> approxCells =
                H3Utils.approxPathCells(
                        target.getCoordinateN(0), target.getCoordinateN(1), 8, true);
    ...
    public void approxPathCellsPentagon() {
        ...
        List<Long> cells =
                H3Utils.approxPathCells(
                        target.getCoordinateN(0), target.getCoordinateN(1), 10, true);
        Long pentagonCell =
    ...
    public void lineStringToCells() {
        LineString target =
                GEOMETRY_FACTORY.createLineString(
                        coordArray(
                                -122.589, 37.743, -122.532, 37.771, -122.423, 37.742, -122.323,
                                37.842));
    ...
    public void lineStringCrossPentagonToCellsNonFullCover() {
        ...
        List<Long> approxCells =
                H3Utils.approxPathCells(
                        target.getCoordinateN(0), target.getCoordinateN(1), 6, true);
