...
public class OutDbResourcePoolTest {
    ...
    public void testAcquireAndRelease() {
        ...
        // Acquire resource again from the resource pool, will obtain the same resource and increase the ref count
        ...
        // Release the resource. The resource is being acquired as resource2, so it is not free resource.
