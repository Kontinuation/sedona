...
public class SubdividedMultiPointPackingTest {
  ...
  public void testSubdivideSinglePoint() {
    MultiPoint multiPoint =
        factory.createMultiPointFromCoords(new Coordinate[] {new Coordinate(10, 20)});
  ...
  public void testSubdivide() {
    ...
    MultiPoint combinedGeom =
        factory.createMultiPointFromCoords(subdivided.toArray(new Coordinate[0]));
