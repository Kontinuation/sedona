...
public class ConstructorTest extends TestBase {
    ...
    public void test2DPoint() {
        ...
        Table geomTable =
                pointTable.select(
                        call(
                                        Constructors.ST_Point.class.getSimpleName(),
                                        $(colNames[0]),
                                        $(colNames[1]))
                                .as(colNames[2]));
    ...
    public void testMakePoint() {
        ...
        Table geomTable =
                pointTable.select(
                        call(
                                        Constructors.ST_MakePoint.class.getSimpleName(),
                                        $(colNames[0]),
                                        $(colNames[1]))
                                .as(colNames[2]));
    ...
    public void testPointFromText() {
        ...
        assertEquals(
                data.get(data.size() - 1).getField(0).toString(), result.getField(0).toString());
    }
    ...
    public void testLineFromText() {
        ...
        Table lineStringTable =
                createLineStringTextTable(testDataSize)
                        .select(
                                call(
                                                Constructors.ST_LineFromText.class.getSimpleName(),
    ...
    public void testLineStringFromText() {
        ...
        Table lineStringTable =
                createLineStringTextTable(testDataSize)
                        .select(
                                call(
                                                Constructors.ST_LineStringFromText.class
                                                        .getSimpleName(),
                                                $(linestringColNames[0]))
                                        .as(linestringColNames[0]),
                                $(linestringColNames[1]));
    ...
    public void testGeomFromWKT() {
        ...
        Table geomTable =
                wktTable.select(
                        call(
                                        Constructors.ST_GeomFromWKT.class.getSimpleName(),
                                        $(polygonColNames[0]))
    ...
    public void testGeomFromEWKT() {
        ...
        geomTable =
                geomTable.select(
                        call(
                                        Constructors.ST_GeomFromEWKT.class.getSimpleName(),
    ...
    public void testGeomFromText() {
        ...
        Table geomTable =
                wktTable.select(
                        call(
                                        Constructors.ST_GeomFromText.class.getSimpleName(),
                                        $(polygonColNames[0]))
                                .as(polygonColNames[0]),
                        $(polygonColNames[1]));
        Row result = last(geomTable);
    ...
    public void testGeomFromGeoJSON() {
        ...
        Table geomTable =
                geojsonTable.select(
                        call(
                                        Constructors.ST_GeomFromGeoJSON.class.getSimpleName(),
                                        $(polygonColNames[0]))
                                .as(polygonColNames[0]),
                        $(polygonColNames[1]));
    ...
    public void testGeomFromWKBBytes() {
        byte[] wkb =
                new byte[] {
                    1, 2, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, -124, -42, 0, -64, 0, 0, 0, 0, -128, -75,
        ...
        Table wkbTable =
                tableEnv.fromDataStream(wkbDS, $(polygonColNames[0]), $(polygonColNames[1]));

        Table geomTable =
                wkbTable.select(
                        call(
                                        Constructors.ST_GeomFromWKB.class.getSimpleName(),
                                        $(polygonColNames[0]))
                                .as(polygonColNames[0]),
                        $(polygonColNames[1]));
        String result = first(geomTable).getFieldAs(0).toString();
    ...
    public void testGeomFromGeoHash() {
        ...
        String result = first(geomTable).getFieldAs(0).toString();
        String expectedGeom =
                "POLYGON ((-180 -39.375, -180 -33.75, -168.75 -33.75, -168.75 -39.375, -180"
                        + " -39.375))";
    ...
    public void testGeomFromGeoHashNullPrecision() {
        ...
        String result = first(geomTable).getFieldAs(0).toString();
        String expectedGeom =
                "POLYGON ((-178.4168529510498 -37.69778251647949, -178.4168529510498"
                        + " -37.697739601135254, -178.41681003570557 -37.697739601135254,"
                        + " -178.41681003570557 -37.69778251647949, -178.4168529510498"
                        + " -37.69778251647949))";
    ...
    public void testGeomFromGML() {
        ...
        Table geomTable =
                wktTable.select(
                        call(
                                        Constructors.ST_GeomFromGML.class.getSimpleName(),
                                        $(polygonColNames[0]))
                                .as(polygonColNames[0]),
                        $(polygonColNames[1]));
    ...
    public void testGeomFromKML() {
        ...
        Table geomTable =
                wktTable.select(
                        call(
                                        Constructors.ST_GeomFromKML.class.getSimpleName(),
                                        $(polygonColNames[0]))
                                .as(polygonColNames[0]),
                        $(polygonColNames[1]));
        assertTrue(first(geomTable).getField(0) instanceof Polygon);
    ...
    public void testMLineFromText() {
        ...
        Table geomTable =
                geohashTable.select(
                        call(
                                        Constructors.ST_MLineFromText.class.getSimpleName(),
                                        $(multilinestringColNames[0]))
                                .as(multilinestringColNames[0]),
                        $(multilinestringColNames[1]));
        String result = first(geomTable).getFieldAs(0).toString();
