...
public class Functions {
    ...
    public static class ST_LineSubstring extends ScalarFunction {
        ...
        public Geometry eval(
            ...
            Geometry geom = (Geometry) o;
            return org.apache.sedona.common.Functions.lineSubString(
                    geom, startFraction, endFraction);
        }
    }
    ...
    public static class ST_MakePolygon extends ScalarFunction {
        ...
        public Geometry eval(
            ...
            return org.apache.sedona.common.Functions.makePolygon(
    ...
    public static class ST_SimplifyPreserveTopology extends ScalarFunction {
        ...
        public Geometry eval(
            ...
            Geometry geom = (Geometry) o;
            return org.apache.sedona.common.Functions.simplifyPreserveTopology(
