  ...
  private val geometries: Seq[(Geometry, Int)] = Seq(
    ...
    makeGeometry(
      """Polygon ((365263.47518765379209071 4063668.33383210469037294,
        ...
        |""".stripMargin, 32649),
    // Intersects with both the raster in Japan and the raster in China
    makeGeometry(
      """Polygon ((365263.47518765379209071 4063668.33383210469037294,
        |399451.69224443659186363 3941531.93014299822971225,
        |460336.44393422664143145 4039658.63395863398909569,
    ...
    makeGeometry(
      """Polygon ((-362725.6544502618489787 202993.71727748692501336,
        ...
        |-362725.6544502618489787 202993.71727748692501336))""".stripMargin, 0),
    makeGeometry(
    ...
    // Contains the raster with no CRS
    makeGeometry("""Polygon ((900 1100, 1100 1100, 1100 900, 900 900, 900 1100))""", 0),
